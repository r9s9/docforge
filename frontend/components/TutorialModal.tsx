    ...
    render: () => (
      <>
        ...
        <ol className="tut-list">
          <li>
            <b>Upload 1 to 5 finished .docx files.</b> One is enough; more examples of the same
  ...
  },
  {
    ...
    render: () => (
      <>
        ...
        <ul className="tut-list">
          <li>
            <b>Form</b> gives one input per field: text boxes, checkboxes, dropdowns, image uploads,
            and editable tables.
          </li>
          <li>
